                        ...
                        {news.map(item => (
                            <div key={item.id} className="bg-white rounded-xl overflow-hidden shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                                ...
                                <div className="p-4">
                                    ...
                                    <Button variant="outline" size="sm" className="mt-2 text-xs p-0 h-auto hover:bg-transparent text-brand-red font-bold border-none shadow-none hover:text-brand-red hover:underline">Read more</Button>
                                </div>
                            </div>
                        ))}
                    </div>
